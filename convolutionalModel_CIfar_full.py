...
def model_cifar(X_train, Y_train, X_test, Y_test, learning_rate = 0.009, num_epochs = 2, minibatch_size = 16, print_cost = True):
    """
    ...
    with tf.Session() as sess:
        ...
        save_path = saver.save(sess, "model/model_softmax.ckpt")
        print("Model saved in path: %s" % save_path)
                
        return train_accuracy, test_accuracy, parameters
    
_, _, parameters = model_cifar(X_train, Y_train, X_test, Y_test)